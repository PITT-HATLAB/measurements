...
Al_config.ch1_range = 0.04
Al_config.ch2_range = 0.04
...
#%%
DATADIR = r'Z:\Data\Hakan\Finite_IF_loopbacks'
mod_freq = 50e6
...
# pump_powers = np.linspace(-1.4, -0.7, 8)
SG_pow_20dB = -6.6
SG_freq = 12.1313e9
# pump_powers = [-20]
...
AWG_config.Sig_freq = target_freq-50e6
AWG_config.Ref_freq = target_freq+50e6

name = 'loopback_finite_IF'

cmpc = PC.cavity_mimicking_pulse_class_IF(
    # name 
    name,
    #AWG_inst
    AWG,
...
PS = PU.Pulse_Sweep_finite_IF(name, AWG, AWG_config, Alazar_ctrl, Al_config, SC4, SC9)
