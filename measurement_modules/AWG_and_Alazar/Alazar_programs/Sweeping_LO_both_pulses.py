...
#%%
DATADIR = r'E:\Data\Cooldown_20210611\SNAIL_Amps\C1\phase_preserving_checks\15dB\amp_on\Multi_LO_sweep'
...
#%%
cf = 6.102e9
LO_freqs = np.arange(cf-14e6, cf+15e6, 1e6)
#%%
...
for LO_freq in LO_freqs: 
    ...
    PS.set_independent_parameter(p, 0, 2*np.pi, 33, arange = False, filename = f'LO_{LO_freq}_15dB_Gain_pt_amp_{amp_pump}')
    PS.sweep(DATADIR)
